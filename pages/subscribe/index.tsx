...
export default function Subscribe() {
	return (
		<div className="subscribe">
			...
			<p>If you are not redirected, please use <a href="https://docs.google.com/forms/d/e/1FAIpQLSepzFs9XYC-Dfenzf5Y4xnwfPs5MBzpPhgoRzNYmsBtFAfa5g/viewform">this link</a>.</p>
			{/* <style jsx>{`
				h1 {
					text-align: center;
					font-weight: 600;
