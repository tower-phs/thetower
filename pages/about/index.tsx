...
export default function About() {
	return (
		<div className="about">
			...
			<p>
				All letters and articles are welcome for consideration. Please email all submissions to <span>phstowersenioreditors@gmail.com</span>.
				The editors reserve the rights to alter letters for length and to edit articles. The Editors-in-Chief take full responsibility for the
